...
class NewCustomFlip2 extends StatefulWidget {
  // final int index;

  const NewCustomFlip2({super.key, m,});

  @override
  State<NewCustomFlip2> createState() => _CustomFlip2State();
}

class _CustomFlip2State extends State<NewCustomFlip2>
    ...
    return Scaffold(
      body: SizedBox(
        ...
        child: GestureDetector(
          // onTapDown: (value){
          //   final p =value.globalPosition;
          //   print('x - ${p.dx} : y -${p.dy}');
          // },
          // onTapUp:  (value){
          //   final p =value.globalPosition;
          //   print('up x - ${p.dx} :up y -${p.dy}');
          // },
